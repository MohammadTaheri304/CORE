...
public class Transaction {
    public final static String SCHEMA_TABLE = "core.transactions";
    ...
    public Transaction(String extuid, long fromAccountId, long toAccountId, BigDecimal amount, String description) {
        this.extuid = extuid;
